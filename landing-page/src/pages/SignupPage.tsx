        ...
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">
              Create your LINQ account today
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                required
                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
              >
