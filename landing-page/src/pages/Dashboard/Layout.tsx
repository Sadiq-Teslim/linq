        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={() => navigate("/")} className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold text-white tracking-tight hidden sm:block">LINQ</span>
            </button>
            {!loading && !isActive && (
          ...
          <div className="px-4 py-4 space-y-2 border-t border-white/5">
            ...
            <div className="pt-2 border-t border-white/5">
              <div className="px-4 py-2">
                <span className="text-sm text-white block">{user?.email}</span>
                <span className="text-xs text-slate-500 capitalize">{plan.replace("_", " ")} Plan</span>
              </div>
              <button
                onClick={handleLogout}
